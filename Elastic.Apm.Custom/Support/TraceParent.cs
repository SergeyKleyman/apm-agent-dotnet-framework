...
namespace Elastic.Apm.Custom.Support
{
    ...
    internal static class TraceParent
    {
        ...
        internal static DistributedTracingData TryExtractTraceparent(string traceParentValue)
        {
            ...
            return DistributionData.GetTracingData(traceId, parentId, (traceFlags & FlagRecorded) == FlagRecorded);
        }
        ...
        public static string BuildTraceparent(string traceId, string parentId, bool flagRecorded)
            => $"00-{traceId}-{parentId}-{(flagRecorded ? "01" : "00")}";
